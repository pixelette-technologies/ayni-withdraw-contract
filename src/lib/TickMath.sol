...
/// @notice This is taken directly from Uniswap V3 core repository:
/// https://github.com/Uniswap/v3-core/blob/main/contracts/libraries/TickMath.sol,
/// with the only difference being the explicit type casting on line 27 to accomodate solidity 0.8
