...
/// @notice
/// This is taken directly from Uniswap V3 core repository:
/// https://github.com/Uniswap/v3-core/blob/main/contracts/libraries/FullMath.sol,
/// with the only difference being on line 67, where we express the same two's-complement logic as `~denominator + 1` to
